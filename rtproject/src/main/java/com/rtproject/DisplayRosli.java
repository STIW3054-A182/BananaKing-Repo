        ...
        final String playerName = pro.getProperty("player");
            ...
            for(Element row : doc.select("table.CRs1 tr")){
                ...
                if(playerName.equals(player.getName().get(i))){
                    System.out.println("---------------------------------------------------------------------------------------------------------------------------------");
                    System.out.printf("%-3s | %-3s | %-30s | %-5s | %-5s | %-15s | %-5s | %-7s | %-7s | %-7s | %-10s |\n", player.getRank().get(0), player.getSno().get(0), player.getName().get(0), player.getFed().get(0), player.getRtg().get(0), player.getClub_city().get(0),player.getPts().get(0),player.getTb1().get(0),player.getTb2().get(0), player.getTb3().get(0),"Category");
                    System.out.println("---------------------------------------------------------------------------------------------------------------------------------");
                    System.out.printf("%-3s | %-3s | %-30s | %-5s | %-5s | %-15s | %-5s | %-7s | %-7s | %-7s | %-10s |\n", player.getRank().get(i), player.getSno().get(i), player.getName().get(i), player.getFed().get(i), player.getRtg().get(i), player.getClub_city().get(i),player.getPts().get(i),player.getTb1().get(i),player.getTb2().get(i), player.getTb3().get(i),cat);
                    System.out.println("---------------------------------------------------------------------------------------------------------------------------------");
                    System.out.println("");
                    break;
                }
